...
void delete_low_similarities(const string &collection_cosine_file , const string &queries_cosine_file , unordered_map< string , unordered_map<string,double> > &all_cos , unordered_map<string,double> &all_sum_cos , const double &threshold){
	...
	while(iterator != queries_cosine.end()){
		...
		if(iterator->second.size() != 0){
			...
			cout<< "Considered word : " << iterator->first <<endl;
	...
	cout<<"Sum size elements queries_cosine : "<< stop <<endl;
	...
	/*cout<<"Size all_cos : "<< all_cos.size() <<endl;
	...
	cout<<"Sum size elements all_cos : "<< stop <<endl;
...
int main(int argc, char** argv) {
	...
	string collection_file = "../data/collection/stop_string_content";
	//string collection_file = "../data/collection/short_collection";
	//string queries_file = "../data/queries/stop_queries.txt";
	string queries_file = "../data/queries/stop_queries_2012.txt";	
	//string queries_file = "../data/queries/synthetic_queries";

	if(argc > 1 && string(argv[1]) == "cosine"){

		string collection_cosine_file = "../data/embeddings/GoogleNews-vectors-negative300/stop_cos04";
		//string queries_cosine_file = "../data/embeddings/GoogleNews-vectors-negative300/cos_queries_04";
		string queries_cosine_file = "../data/embeddings/GoogleNews-vectors-negative300/stop_cos_queries_04";
